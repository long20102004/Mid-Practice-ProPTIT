...
public class Map {
    ...
    public void setMap(String pictureName) {
        ...
        player.stick = Utility.importImg(Utility.stick).getSubimage(484, 933, SQUARE_WIDTH, 1);
    ...
    public void renderMap(Graphics g) {
        for (int i = 0; i < NUMBER_OF_SQUARE; i++) {
            for (int j = 0; j < NUMBER_OF_SQUARE; j++) {
                g.drawImage(player.stick, j * SQUARE_WIDTH, i * SQUARE_HEIGHT, SQUARE_WIDTH, SQUARE_HEIGHT, null);
